...
/**
 * Player progress: best number of stars per level (0–3).
 * DataStore Preferences for the POC; Proto DataStore + Codex planned for the
 * full Stage 5 (todo.md §4.4).
 */
object Progress {
    ...
    /** levelId → best stars; a missing level has not been completed yet. */
    ...
    /** Record a completion; only the best score is kept. */
